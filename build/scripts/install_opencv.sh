# prerequisites brew with macos: https://www.pyimagesearch.com/2018/08/17/install-opencv-4-on-macos/
...
cmake $BUILD_FLAGS -D CMAKE_BUILD_TYPE=RELEASE -D CMAKE_INSTALL_PREFIX=/usr/local ..
# fails:
